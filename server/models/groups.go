...
type Group struct {
	...
	WorkflowState GroupsWorkflowState `boil:"workflow_state" json:"workflow_state" toml:"workflow_state" yaml:"workflow_state"`
	Type          GroupsType          `boil:"type" json:"type" toml:"type" yaml:"type"`
...
var GroupTableColumns = struct {
	...
	ID:            "groups.id",
	Name:          "groups.name",
	WorkflowState: "groups.workflow_state",
	Type:          "groups.type",
...
type whereHelperGroupsWorkflowState struct{ field string }

func (w whereHelperGroupsWorkflowState) EQ(x GroupsWorkflowState) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperGroupsWorkflowState) NEQ(x GroupsWorkflowState) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperGroupsWorkflowState) LT(x GroupsWorkflowState) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperGroupsWorkflowState) LTE(x GroupsWorkflowState) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperGroupsWorkflowState) GT(x GroupsWorkflowState) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperGroupsWorkflowState) GTE(x GroupsWorkflowState) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperGroupsWorkflowState) IN(slice []GroupsWorkflowState) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
func (w whereHelperGroupsWorkflowState) NIN(slice []GroupsWorkflowState) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
type whereHelperGroupsType struct{ field string }

func (w whereHelperGroupsType) EQ(x GroupsType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperGroupsType) NEQ(x GroupsType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperGroupsType) LT(x GroupsType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperGroupsType) LTE(x GroupsType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperGroupsType) GT(x GroupsType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperGroupsType) GTE(x GroupsType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperGroupsType) IN(slice []GroupsType) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
func (w whereHelperGroupsType) NIN(slice []GroupsType) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
var GroupWhere = struct {
	...
	WorkflowState whereHelperGroupsWorkflowState
	Type          whereHelperGroupsType
	...
	WorkflowState: whereHelperGroupsWorkflowState{field: "\"groups\".\"workflow_state\""},
	Type:          whereHelperGroupsType{field: "\"groups\".\"type\""},
	CreatedBy:     whereHelperint64{field: "\"groups\".\"created_by\""},
...
func (r *groupR) GetCreatedByUser() *User {
	if r == nil {
		return nil
	}
...
func (r *groupR) GetGroupUsers() GroupUserSlice {
	if r == nil {
		return nil
	}
	return r.GroupUsers
...
var (
	groupAllColumns            = []string{"id", "name", "workflow_state", "type", "created_by", "created_at", "updated_at", "deleted_at"}
	groupColumnsWithoutDefault = []string{"id", "name", "workflow_state", "type", "created_by"}
	groupColumnsWithDefault    = []string{"created_at", "updated_at", "deleted_at"}
...
func (o *Group) CreatedByUser(mods ...qm.QueryMod) userQuery {
...
func (groupL) LoadCreatedByUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeGroup interface{}, mods queries.Applicator) error {
	var slice []*Group
	var object *Group
...
func (groupL) LoadGroupUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeGroup interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`group_users`),
		qm.WhereIn(`group_users.group_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetCreatedByUser of the group to the related item.
// Sets o.R.CreatedByUser to related.
// Adds o to related.R.CreatedByGroups.
func (o *Group) SetCreatedByUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
