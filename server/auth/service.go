...
func (a *Auther) verifyAccessToken(token string) (*Claims, error) {
...
func (s *Service) Login(ctx context.Context, username, password string) (LoginResponse, error) {
	...
	accessToken, userFingerprint, _, err := s.auther.newAccessToken(user)
	if err != nil {
...
func (s *Service) RefreshToken(ctx context.Context, refreshToken, fingerprintHash, fingerprint string) (RefreshTokenResponse, error) {
